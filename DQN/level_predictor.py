...
def main():
    ...
    for episode in range(EPISODES):
        ...
        while True:
            ...
            action3 = np.argmax(agent.level_two().predict(state)[0])
    ...
    filename = 'D:/Documents/self_driving_car/models/intersection/levelThreeImprovedModel.h5'
    save_model(agent.target_model, filename)
    agent.target_model.save_weights('D:/Documents/self_driving_car/models/intersection/levelThreeImproved.h5')
    print("Model Saved!")
    plotLoss()
    plotReward()
